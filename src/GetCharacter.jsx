...
const characters = ['Random', 'Homer', 'Moe', 'Bart',  'Lisa', 'Marge', 'Dr. Nick', 'Duffman', 'Chief Wiggum', 'Ralph Wiggum', 'Apu', 'Principal Skinner', 'Milhouse', 'Comic Book Guy', 'Otto', 'Mayor Quimby', 'Rainier Wolfcastle']
